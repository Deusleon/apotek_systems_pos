...
@section('content-sub-title')
    ...
    <li class="breadcrumb-item"><a href="#">Sales / Credit Sales / Payments</a></li>
@endsection
                    ...
                    @if(auth()->user()->checkPermission('View Credit Sales'))
                        <li class="nav-item">
                            <a class="nav-link text-uppercase" id="credit-sale-receiving-tablist"
                                href="{{ route('credit-sales.creditSale') }}" role="tab" aria-controls="credit_sales" aria-selected="false">New
                                Sale</a>
                        </li>
                    @endif
                    ...
                    @if(auth()->user()->checkPermission('View Credit Payments'))
                        <li class="nav-item">
                            <a class="nav-link text-uppercase active" id="credit-payment-tablist" 
                                href="{{ route('credit-payments.getCreditsCustomers') }}" role="tab" aria-controls="credit_payment" aria-selected="true">Payments
                            </a>
                        </li>
                    @endif
                </ul>

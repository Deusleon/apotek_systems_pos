...
<body>
    ...
    <div style="width: 100%; text-align: center; align-items: center;">
        ...
        <div>
            <h3 align="center" style="font-weight: bold; margin-top: -1%">Stock Below Minimum Level Report {{ $isMultiStore ? '(' . current_store()->name . ')' : '' }}</h3>
                ...
                <table id="table-detail" align="center">
                    ...
                    @foreach($data as $item)
                        <tr>
                            ...
                            <td align="center">{{smartFormat($item->min_quantinty)}}</td>
                            <td align="center">{{smartFormat($item->qty)}}</td>
                        </tr>
                    @endforeach
                </table>
            </div>

...
Route::middleware(["auth","main_branch"])->group(function () {
    ...
    //Mobile POS routes
    Route::get('mobile-pos', 'SaleController@mobilePOS')->name('mobile-pos.index');
    Route::post('mobile-pos/complete-sale', 'SaleController@storeMobileSale')->name('mobile-pos.storeMobileSale');
    Route::get('mobile-pos/get-products', 'SaleController@getMobileProducts')->name('mobile-pos.getProducts');

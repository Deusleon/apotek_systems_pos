<div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form id="form_product_edit" action="<?php echo e(route('products.update', ['product' => ':id'])); ?>" method="post">
                <?php echo csrf_field(); ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" id="pack_size_edit" name="pack_size"
                                        value="<?php echo e(old('pack_size')); ?>" placeholder="e.g. 6, 12, 24"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" id="max_stock_edit" name="max_quantinty"
                                        value="<?php echo e(old('max_quantinty')); ?>" onkeypress="return isNumberKey(event,this)">
                                </div>
                            </div>
...
</div><?php /**PATH C:\Users\Little Pro\Desktop\APOTEk\apotek_systems_pos\resources\views/masters/products/edit.blade.php ENDPATH**/ ?>
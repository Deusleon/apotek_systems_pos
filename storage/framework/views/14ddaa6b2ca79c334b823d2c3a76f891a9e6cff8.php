...
<body>
    ...
    <div class="pcoded-main-container">
                ...
                <div class="m-header">
                    <a href="index.html" class="b-brand">
                        ...
                        <a class="mobile-menu" style="color: #ffffff; font-weight: bold; height: 43px; width: auto;" id="mobile-collapse"
                            href="<?php echo e(route('logout')); ?>" class="dud-logout" title="Logout" onclick="event.preventDefault();
        ...
        <div id="receipt-print" style="display:block; visibility:hidden;">
            <div class="receipt-header">
                ...
                <div class="receipt-info2" id="receiptDate">Date: <?php echo e(date('Y-m-d H:i:s')); ?></div>
            ...
            <div class="receipt-footer">
                <div class="receipt-info">Issued By: <?php echo e(Auth::user()->name); ?></div>
    ...
    <script>
        ...
        function completeSale() {
            ...
            fetch('<?php echo e(route("mobile-pos.storeMobileSale")); ?>', {
                method: 'POST',
                headers: {
...
</html><?php /**PATH C:\Users\Little Pro\Desktop\APOTEk\apotek_systems_pos\resources\views/sales/mobile-pos.blade.php ENDPATH**/ ?>
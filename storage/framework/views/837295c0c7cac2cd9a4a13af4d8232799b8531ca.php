...
<?php $__env->startSection("content"); ?>
                        ...
                        <div class="d-flex justify-content-end mr-3">
                            <div class="d-flex align-items-center" style="width: 270px;">
                                ...
                                <select name="price_category" class="js-example-basic-single form-control"
                                    id="price_category">
                                    <?php $__currentLoopData = $price_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $price_category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($price_category->id); ?>" <?php echo e($default_sale_type === $price_category->name ? 'selected' : ''); ?>>
                                            <?php echo e($price_category->name); ?>
                    ...
                    <div id="pendingTable" class="table-responsive">
                        <table id="pendingPrices" class="display table nowrap table-striped table-hover" style="width:100%">
                            <thead>
                                <tr>
                                    <th>Product Name</th>
                                    <?php if($batch_enabled === 'YES'): ?>
                                        <th>Batch Number</th>
                                    <?php endif; ?>
                                    <th>Buy Price</th>
                                    <th>Sell Price</th>
                                    <th>Profit%</th>
                                    <?php if(auth()->user()->checkPermission('Edit Price List')): ?>
                                        <th>Action</th>
                                    <?php endif; ?>
    ...
    <?php echo $__env->make('stock_management.price_list.edit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('stock_management.price_list.show', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('stock_management.price_list.history', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>
...
<?php $__env->startPush("page_scripts"); ?>
    ...
    <script src="<?php echo e(asset("assets/apotek/js/stock-transfer.js")); ?>"></script>
    ...
    <script>
        ...
        function displayVals(data) {
            var val = data;
            var ajaxurl = '<?php echo e(route('myitems')); ?>';
            $('#loading').show();
            $.ajax({
                url: ajaxurl,
                type: "get",
        ...
        function retrivePriceHistory(data, data1) {
            ...
            var ajaxurl = '<?php echo e(route('price-history')); ?>';
            $('#loading').show();
            $.ajax({
                url: ajaxurl,
                type: "get",
        ...
        $(document).ready(function () {
            ...
            $('#price_category, #type_id').on('change', function () {
                ...
                $.ajax({
                    url: '<?php echo e(route("fetch-price-list")); ?>',
                    type: 'GET',
                    dataType: 'json',
                    data: {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make("layouts.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Little Pro\Desktop\APOTEk\apotek_systems_pos\resources\views/stock_management/price_list/index.blade.php ENDPATH**/ ?>
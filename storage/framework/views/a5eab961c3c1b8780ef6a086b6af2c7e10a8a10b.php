                    ...
                    <table id="return_table" class="display table table-striped table-hover" style="width:100%">
                        <thead>
                            <tr>
                                ...
                                <th>Qty Returned</th>
                                <th>Refund</th>
                                <?php if(Auth::user()->checkPermission('Approve Sales Returns')): ?>
                                    <th>Action</th>
                                <?php else: ?>
...
<?php $__env->startPush("page_scripts"); ?>
    ...
    <script src="<?php echo e(asset("assets/js/pages/sales.js")); ?>"></script>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make("layouts.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Little Pro\Desktop\APOTEk\apotek_systems_pos\resources\views/sales/sale_returns_approval/index.blade.php ENDPATH**/ ?>
        ...
        <table class="customer-table">
            <tbody>
                <tr style="width: 100%; position: relative;">
                    <td style="width: 18%; position: absolute; padding-left: 10px;">Invoice # : <span style="margin-left: 3px;"><?php echo e($datas ?? 'N/A'); ?></span></td>
                    <td style="width: 55.5%; padding-left: 10px;">Phone : <span style="margin-left: 3px;"><?php echo e($dat[0]['customer_phone'] ?? 'N/A'); ?></span></td>
                    <td style="width: 26.5%; padding-left: 10px;">TIN : <span style="margin-left: 3px;"><?php echo e(!empty($dat[0]['customer_tin']) ? $dat[0]['customer_tin'] : 'N/A'); ?></span></td>
                </tr>
                <tr style="width: 100%; position: relative;">
                    <td style="width: 18%; position: absolute; padding-left: 10px;">Invoice Date : <span style="margin-left: 3px;"><?php echo e(date('Y-m-d', strtotime($dat[0]['created_at']))); ?></span></td>
                    <td style="width: 55.5%; padding-left: 10px;">Address : <span style="margin-left: 3px;"><?php echo e($dat[0]['customer_address'] ?? 'N/A'); ?></span></td>
                    <td style="width: 26.5%; padding-left: 10px;">Grace Period : <span style="margin-left: 3px;"><?php echo e(!empty($dat[0]['grace_period']) ? $dat[0]['grace_period'] : 'N/A'); ?></span></td>
                </tr>
                <tr style="width: 100%; position: relative;">
                    <td colspan="2" style="width: 42%; padding-left: 10px;">Bill To : <span style="margin-left: 3px;"><?php echo e($dat[0]['customer'] ?? 'CASH'); ?></span></td>
    ...
    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $datas => $dat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <table class="items-table">
            ...
            <tbody>
                <?php $__currentLoopData = $dat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td style="width: 20px; text-align: center;"><?php echo e($loop->iteration); ?>.</td>
                        <td style="width: 355px; text-align: left; padding-left: 7px;"><?php echo e($item['name']); ?>

                            <?php echo e($item['brand'] ?? ''); ?>

                            <?php echo e($item['pack_size'] ?? ''); ?><?php echo e($item['sales_uom'] ?? ''); ?>

                        </td>
                        <td style="width: 49px; text-align: center;"><?php echo e(smartFormat($item['quantity'])); ?></td>
                        <td style="width: 70px; text-align: right; padding-right: 3px;"><?php echo e(customRound($item['price'])); ?></td>
                        <td style="width: 89px; text-align: right; padding-right: 3px;"><?php echo e(customRound($item['vat'])); ?></td>
                        <td style="width: 89px; text-align: right; padding-right: 3px;"><?php echo e(customRound(($item['price'] * $item['quantity']) + $item['vat'])); ?>
        ...
        <div style="display: flex; justify-content: space-between; width: 100%;">
            <div style="width: 70%; padding-top: 10px;">
                ...
                <?php if($generalSettings && $generalSettings->credit_sale_terms): ?>
                    <div style="">
                        ...
                        <div style="font-size: 11px; line-height: 1.4; text-align: justify;">
                            <?php echo nl2br(e($generalSettings->credit_sale_terms)); ?>
            ...
            <div class="summary-section" style="width: 26.7%; margin-top: 0px; padding-top: 0; float: right;">
                <table class="summary-table" style="margin-bottom: 60px;">
                    <tr>
                        ...
                        <td align="right" style="padding-right: 3px;"><?php echo e(customRound($subTotal)); ?></td>
                    </tr>
                    <?php if($dat[0]['discount_total'] > 0): ?>
                        <tr>
                            <td align="right" style="width: 50%; font-weight: bold; padding-right: 5px;">Discount : </td>
                            <td align="right" style="padding-right: 3px;"><?php echo e(customRound($dat[0]['discount_total'])); ?></td>
                        </tr>
                    <?php endif; ?>
                    <tr>
                        <td align="right" style="width: 50%; font-weight: bold; padding-right: 5px;">VAT : </td>
                        <td align="right" style="padding-right: 3px;"><?php echo e(customRound($dat[0]['total_vat'])); ?></td>
                    </tr>
                    <tr>
                        <td align="right" style="width: 50%; font-weight: bold; padding-right: 5px;">Total : </td>
                        <td align="right" style="padding-right: 3px;"><?php echo e(customRound($grandTotal)); ?></td>
                    </tr>
                    <?php if($page == -1): ?>
                        <tr>
                            <td align="right" style="width: 50%; font-weight: bold; padding-right: 5px;">Paid : </td>
                            <td align="right" style="padding-right: 3px;"><?php echo e(customRound($dat[0]['paid'])); ?></td>
                        </tr>
                        <tr>
                            <td align="right" style="width: 50%; font-weight: bold; padding-right: 5px;">Balance : </td>
                            <td align="right" style="padding-right: 3px;"><?php echo e(customRound($dat[0]['grand_total'] - $dat[0]['paid'])); ?></td>
                        </tr>
                    <?php endif; ?>
                </table>
...
</html><?php /**PATH D:\MY DOCUMENTS\PROJECTS\LARAVEL\APOTEk\Repo-project\apotek_systems_pos\resources\views/sales/cash_sales/credit_receipt_A4.blade.php ENDPATH**/ ?>
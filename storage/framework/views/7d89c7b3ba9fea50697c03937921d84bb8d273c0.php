        ...
        <table class="customer-table">
            <tbody>
                <tr style="width: 100%; position: relative;">
                    <td style="width: 22%; position: absolute; padding-left: 10px;">Proforma # : <span style="margin-left: 3px;"><?php echo e($datas ?? 'N/A'); ?></span></td>
                    <td style="width: 54.5%; padding-left: 10px;">Phone : <span style="margin-left: 3px;"><?php echo e($dat[0]['customer_phone'] ?? 'N/A'); ?></span></td>
                    <td style="width: 27.5%; padding-left: 10px;">TIN : <span style="margin-left: 3px;"><?php echo e(!empty($dat[0]['customer_tin']) ? $dat[0]['customer_tin'] : 'N/A'); ?></span></td>
                </tr>
                <tr style="width: 100%; position: relative;">
                    <td style="width: 22%; position: absolute; padding-left: 10px;">Proforma Date : <span style="margin-left: 3px;"><?php echo e(date('Y-m-d', strtotime($dat[0]['created_at']))); ?></span></td>
                    <td style="width: 54.5%; padding-left: 10px;">Address : <span style="margin-left: 3px;"><?php echo e(!empty($dat[0]['customer_address']) ? $dat[0]['customer_address'] : 'N/A'); ?></span></td>
                    <td style="width: 27.5%; padding-left: 10px;">Ref # : <span style="margin-left: 3px;"><?php echo e($dat[0]['ref_no'] ?? 'N/A'); ?></span></td>
                </tr>
                <tr style="width: 100%; position: relative;">
    ...
    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $datas => $dat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <?php $__currentLoopData = $dat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td style="width: 355px; text-align: left; padding-left: 7px;"><?php echo e($item['name']); ?>
                            ...
                            <?php echo e($item['pack_size'] ?? ''); ?><?php echo e($item['sales_uom'] ?? ''); ?></td>
                        ...
                        <td style="width: 89px; text-align: right; padding-right: 3px;"><?php echo e(customRound($item['price'] * $item['quantity'])); ?>
        ...
        <div style="display: flex; justify-content: space-between; width: 100%;">
            <div style="width: 70%; padding-top: 10px;">
                ...
                <?php if($generalSettings && $generalSettings->proforma_invoice_terms): ?>
                    <div style="">
                        ...
                        <div style="font-size: 11px; line-height: 1.4; text-align: justify;">
                            <?php echo nl2br(e($generalSettings->proforma_invoice_terms)); ?>
                ...
                <table class="summary-table" style="margin-bottom: 60px;">
                    ...
                    <?php if($page == -1): ?>
                        ...
                        <tr>
                            ...
                            <td align="right" style="padding-right: 3px;"><?php echo e(customRound($grandTotal - $dat[0]['paid'])); ?></td>
                        </tr>
                    <?php endif; ?>
                </table>
...
</html><?php /**PATH C:\Users\Little Pro\Desktop\APOTEk\apotek_systems_pos\resources\views/sales/sale_quotes/quote_receipt_A4.blade.php ENDPATH**/ ?>
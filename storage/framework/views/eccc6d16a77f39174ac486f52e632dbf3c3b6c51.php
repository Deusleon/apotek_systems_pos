                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <?php if(auth()->user()->checkPermission('Add Petty Cash')): ?>
...
<?php echo $__env->make("accounting.petty_cash.set_opening", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make("accounting.petty_cash.add_expense", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make("accounting.petty_cash.show_expenses", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
var hasAddPermission = <?php echo json_encode(auth()->user()->checkPermission('Add Petty Cash'), 15, 512) ?>;
...
$(document).on('click', '#add-expense-submit', function(e) {
    ...
    $.ajax({
        url: '<?php echo e(url("petty-cash")); ?>/' + pettyCashId + '/add-expense',
        type: 'POST',
        data: formData,
        processData: false,
        contentType: false,
...
function filterPettyCashDate(dates) {
    ...
    $.ajax({
        url: '<?php echo e(route("petty-cash.filter-by-date")); ?>',
        type: 'GET',
        dataType: 'json',
        data: {
            from_date: from_date,
...
function loadExpenses(pettyCashId) {
    $.ajax({
        url: '<?php echo e(url("petty-cash")); ?>/' + pettyCashId + '/expenses',
        type: 'GET',
        success: function (data) {
            var html = '';
...
function updatePreviousClosingBalance(date) {
    $.ajax({
        url: '<?php echo e(route("petty-cash.previous-closing")); ?>',
        type: 'GET',
        data: {
            date: date
        },
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make("layouts.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\MY DOCUMENTS\PROJECTS\LARAVEL\APOTEk\Repo-project\apotek_systems_pos\resources\views/accounting/petty_cash/index.blade.php ENDPATH**/ ?>